package foundation.hashtable.openAddressing.impl;

import foundation.hashtable.IHashTable;
import foundation.hashtable.openAddressing.HashNode;
...
public class HashTableOpenAddressingImpl<K, V> implements IHashTable<K, V> {
    ...
    public HashTableOpenAddressingImpl(int capicity) {
        this.capacity = capicity;
        hashNodes = new HashNode[capicity];
    }
